...
GearPower.create(name: '未設定', image: 'unknown.png', gear_category: 0)
GearPower.create(name: 'インク効率アップ（メイン）', image: 'main_ink_saver.png', gear_category: 0)
GearPower.create(name: 'インク効率アップ（サブ）', image: 'sub_ink_saver.png', gear_category: 0)
GearPower.create(name: 'インク回復力アップ', image: 'ink_recovery_up.png', gear_category: 0)
GearPower.create(name: 'ヒト移動速度アップ', image: 'run_speed_up.png', gear_category: 0)
GearPower.create(name: 'イカダッシュ速度アップ', image: 'swim_speed_up.png', gear_category: 0)
GearPower.create(name: 'スペシャル増加量アップ', image: 'special_charge_up.png', gear_category: 0)
GearPower.create(name: 'スペシャル減少量ダウン', image: 'special_saver.png', gear_category: 0)
GearPower.create(name: 'スペシャル性能アップ', image: 'special_power_up.png', gear_category: 0)
GearPower.create(name: '復活時間短縮', image: 'quick_respawn.png', gear_category: 0)
GearPower.create(name: 'スーパージャンプ時間短縮', image: 'quick_super_jump.png', gear_category: 0)
GearPower.create(name: 'サブ性能アップ', image: 'sub_power_up.png', gear_category: 0)
GearPower.create(name: '相手インク影響軽減', image: 'ink_resistance_up.png', gear_category: 0)
GearPower.create(name: '爆風ダメージ軽減・改', image: 'bomb_defence_up_dx.png', gear_category: 0)
GearPower.create(name: 'メイン性能アップ', image: 'main_power_up.png', gear_category: 0)
GearPower.create(name: 'スタートダッシュ', image: 'opening_gambit.png', gear_category: 1)
GearPower.create(name: 'ラストスパート', image: 'last_ditch_effort.png', gear_category: 1)
GearPower.create(name: '逆境強化', image: 'tenacity.png', gear_category: 1)
GearPower.create(name: 'カムバック', image: 'comeback.png', gear_category: 1)
GearPower.create(name: 'イカニンジャ', image: 'ninja_squid.png', gear_category: 2)
GearPower.create(name: 'リベンジ', image: 'haunt.png', gear_category: 2)
GearPower.create(name: 'サーマルインク', image: 'thermal_ink.png', gear_category: 2)
GearPower.create(name: '復活ペナルティアップ', image: 'respawn_punisher.png', gear_category: 2)
GearPower.create(name: '追加ギアパワー倍化', image: 'ability_doubler.png', gear_category: 2)
GearPower.create(name: 'ステルスジャンプ', image: 'stealth_jump.png', gear_category: 3)
GearPower.create(name: '対物攻撃力アップ', image: 'object_shredder.png', gear_category: 3)
GearPower.create(name: '受け身術', image: 'drop_roller.png', gear_category: 3)

User.create(name: 'Sylpha', email: 'sylpha.games@gmail.com', password: 'password')

Gear.create(name: "未設定", category: 1, user_id: 1, main_gear_power_id: 1, sub_gear_power_1_id: 1, sub_gear_power_2_id: 1, sub_gear_power_3_id: 1)
Gear.create(name: "未設定", category: 2, user_id: 1, main_gear_power_id: 1, sub_gear_power_1_id: 1, sub_gear_power_2_id: 1, sub_gear_power_3_id: 1)
Gear.create(name: "未設定", category: 3, user_id: 1, main_gear_power_id: 1, sub_gear_power_1_id: 1, sub_gear_power_2_id: 1, sub_gear_power_3_id: 1)

Gear.create(name: "メイン効率1.2", category: 1, user_id: 1, main_gear_power_id: 2, sub_gear_power_1_id: 2, sub_gear_power_2_id: 2, sub_gear_power_3_id: 13)
Gear.create(name: "サブ効率1.2", category: 1, user_id: 1, main_gear_power_id: 3, sub_gear_power_1_id: 3, sub_gear_power_2_id: 3, sub_gear_power_3_id: 13)
Gear.create(name: "サブ効率1.0 イカ速0.2", category: 1, user_id: 1, main_gear_power_id: 3, sub_gear_power_1_id: 6, sub_gear_power_2_id: 6, sub_gear_power_3_id: 13)
Gear.create(name: "ヒト速1.2", category: 1, user_id: 1, main_gear_power_id: 5, sub_gear_power_1_id: 5, sub_gear_power_2_id: 5, sub_gear_power_3_id: 13)
Gear.create(name: "イカ速1.0 サブ効率0.2", category: 1, user_id: 1, main_gear_power_id: 6, sub_gear_power_1_id: 3, sub_gear_power_2_id: 3, sub_gear_power_3_id: 13)
Gear.create(name: "イカ速1.2", category: 1, user_id: 1, main_gear_power_id: 6, sub_gear_power_1_id: 6, sub_gear_power_2_id: 6, sub_gear_power_3_id: 13)
...
Gear.create(name: "メイン効率1.0 メイン性能0.3", category: 2, user_id: 1, main_gear_power_id: 2, sub_gear_power_1_id: 15, sub_gear_power_2_id: 15, sub_gear_power_3_id: 15)
Gear.create(name: "サブ効率1.0 メイン効率0.2", category: 2, user_id: 1, main_gear_power_id: 3, sub_gear_power_1_id: 2, sub_gear_power_2_id: 2, sub_gear_power_3_id: 11)
Gear.create(name: "サブ効率1.0 イカ速0.2", category: 2, user_id: 1, main_gear_power_id: 3, sub_gear_power_1_id: 6, sub_gear_power_2_id: 6, sub_gear_power_3_id: 11)
Gear.create(name: "サブ効率1.0 スぺ増0.2", category: 2, user_id: 1, main_gear_power_id: 3, sub_gear_power_1_id: 7, sub_gear_power_2_id: 7, sub_gear_power_3_id: 11)
Gear.create(name: "イカ速1.2", category: 2, user_id: 1, main_gear_power_id: 6, sub_gear_power_1_id: 6, sub_gear_power_2_id: 6, sub_gear_power_3_id: 11)
Gear.create(name: "スぺ増1.0 メイン効率0.2", category: 2, user_id: 1, main_gear_power_id: 7, sub_gear_power_1_id: 2, sub_gear_power_2_id: 2, sub_gear_power_3_id: 11)
Gear.create(name: "スぺ増1.0 ヒト速0.2", category: 2, user_id: 1, main_gear_power_id: 7, sub_gear_power_1_id: 5, sub_gear_power_2_id: 5, sub_gear_power_3_id: 11)
Gear.create(name: "スぺ増1.0 イカ速0.2", category: 2, user_id: 1, main_gear_power_id: 7, sub_gear_power_1_id: 6, sub_gear_power_2_id: 6, sub_gear_power_3_id: 11)
Gear.create(name: "スぺ増1.2", category: 2, user_id: 1, main_gear_power_id: 7, sub_gear_power_1_id: 7, sub_gear_power_2_id: 7, sub_gear_power_3_id: 11)
Gear.create(name: "スぺ性能1.0 サブ効率0.2", category: 2, user_id: 1, main_gear_power_id: 9, sub_gear_power_1_id: 3, sub_gear_power_2_id: 3, sub_gear_power_3_id: 11)
Gear.create(name: "スぺ性能1.0 イカ速0.2", category: 2, user_id: 1, main_gear_power_id: 9, sub_gear_power_1_id: 6, sub_gear_power_2_id: 6, sub_gear_power_3_id: 11)
Gear.create(name: "インク軽減1.0 ヒト速0.2", category: 2, user_id: 1, main_gear_power_id: 13, sub_gear_power_1_id: 5, sub_gear_power_2_id: 5, sub_gear_power_3_id: 11)
Gear.create(name: "メイン性能1.2", category: 2, user_id: 1, main_gear_power_id: 15, sub_gear_power_1_id: 15, sub_gear_power_2_id: 15, sub_gear_power_3_id: 11)
Gear.create(name: "イカ忍1.0 イカ速0.2", category: 2, user_id: 1, main_gear_power_id: 20, sub_gear_power_1_id: 6, sub_gear_power_2_id: 6, sub_gear_power_3_id: 11)

Gear.create(name: "サブ効率1.0 スぺ増0.2", category: 3, user_id: 1, main_gear_power_id: 3, sub_gear_power_1_id: 7, sub_gear_power_2_id: 7, sub_gear_power_3_id: 14)
Gear.create(name: "ヒト速1.0 メイン効率0.2", category: 3, user_id: 1, main_gear_power_id: 5, sub_gear_power_1_id: 2, sub_gear_power_2_id: 2, sub_gear_power_3_id: 14)
Gear.create(name: "ヒト速1.2", category: 3, user_id: 1, main_gear_power_id: 5, sub_gear_power_1_id: 5, sub_gear_power_2_id: 5, sub_gear_power_3_id: 14)
Gear.create(name: "イカ速1.0 ヒト速0.2", category: 3, user_id: 1, main_gear_power_id: 6, sub_gear_power_1_id: 5, sub_gear_power_2_id: 5, sub_gear_power_3_id: 14)
Gear.create(name: "イカ速1.2", category: 3, user_id: 1, main_gear_power_id: 6, sub_gear_power_1_id: 6, sub_gear_power_2_id: 6, sub_gear_power_3_id: 14)
Gear.create(name: "メイン性能1.2", category: 3, user_id: 1, main_gear_power_id: 15, sub_gear_power_1_id: 15, sub_gear_power_2_id: 15, sub_gear_power_3_id: 14)
Gear.create(name: "対物1.0 サブ効率0.2", category: 3, user_id: 1, main_gear_power_id: 26, sub_gear_power_1_id: 3, sub_gear_power_2_id: 3, sub_gear_power_3_id: 14)

GearSet.create(user_id: 1, main_weapon_id: 1, headgear_id: 6, clothing_id: 18, shoes_id: 34)
GearSet.create(user_id: 1, main_weapon_id: 2, headgear_id: 10, clothing_id: 23, shoes_id: 34)
GearSet.create(user_id: 1, main_weapon_id: 3, headgear_id: 6, clothing_id: 18, shoes_id: 34)
GearSet.create(user_id: 1, main_weapon_id: 4, headgear_id: 8, clothing_id: 19, shoes_id: 30)
GearSet.create(user_id: 1, main_weapon_id: 5, headgear_id: 5, clothing_id: 24, shoes_id: 34)
GearSet.create(user_id: 1, main_weapon_id: 6, headgear_id: 12, clothing_id: 25, shoes_id: 36)
GearSet.create(user_id: 1, main_weapon_id: 7, headgear_id: 10, clothing_id: 20, shoes_id: 32)
GearSet.create(user_id: 1, main_weapon_id: 8, headgear_id: 6, clothing_id: 20, shoes_id: 32)
GearSet.create(user_id: 1, main_weapon_id: 9, headgear_id: 11, clothing_id: 18, shoes_id: 34)
GearSet.create(user_id: 1, main_weapon_id: 10, headgear_id: 11, clothing_id: 23, shoes_id: 34)
GearSet.create(user_id: 1, main_weapon_id: 11, headgear_id: 11, clothing_id: 18, shoes_id: 34)
GearSet.create(user_id: 1, main_weapon_id: 12, headgear_id: 6, clothing_id: 18, shoes_id: 32)
GearSet.create(user_id: 1, main_weapon_id: 13, headgear_id: 6, clothing_id: 18, shoes_id: 32)
GearSet.create(user_id: 1, main_weapon_id: 14, headgear_id: 10, clothing_id: 18, shoes_id: 32)
GearSet.create(user_id: 1, main_weapon_id: 15, headgear_id: 10, clothing_id: 28, shoes_id: 34)
GearSet.create(user_id: 1, main_weapon_id: 16, headgear_id: 6, clothing_id: 28, shoes_id: 34)
GearSet.create(user_id: 1, main_weapon_id: 17, headgear_id: 10, clothing_id: 28, shoes_id: 34)
GearSet.create(user_id: 1, main_weapon_id: 18, headgear_id: 5, clothing_id: 22, shoes_id: 33)
GearSet.create(user_id: 1, main_weapon_id: 19, headgear_id: 5, clothing_id: 22, shoes_id: 33)
GearSet.create(user_id: 1, main_weapon_id: 20, headgear_id: 4, clothing_id: 22, shoes_id: 33)
GearSet.create(user_id: 1, main_weapon_id: 21, headgear_id: 4, clothing_id: 15, shoes_id: 34)
GearSet.create(user_id: 1, main_weapon_id: 22, headgear_id: 12, clothing_id: 25, shoes_id: 36)
GearSet.create(user_id: 1, main_weapon_id: 23, headgear_id: 4, clothing_id: 15, shoes_id: 34)
GearSet.create(user_id: 1, main_weapon_id: 24, headgear_id: 4, clothing_id: 15, shoes_id: 34)
GearSet.create(user_id: 1, main_weapon_id: 25, headgear_id: 4, clothing_id: 15, shoes_id: 34)
GearSet.create(user_id: 1, main_weapon_id: 26, headgear_id: 4, clothing_id: 23, shoes_id: 34)
GearSet.create(user_id: 1, main_weapon_id: 27, headgear_id: 4, clothing_id: 18, shoes_id: 34)
GearSet.create(user_id: 1, main_weapon_id: 28, headgear_id: 5, clothing_id: 15, shoes_id: 34)
GearSet.create(user_id: 1, main_weapon_id: 29, headgear_id: 4, clothing_id: 15, shoes_id: 34)
GearSet.create(user_id: 1, main_weapon_id: 30, headgear_id: 5, clothing_id: 15, shoes_id: 34)
GearSet.create(user_id: 1, main_weapon_id: 31, headgear_id: 4, clothing_id: 15, shoes_id: 34)
GearSet.create(user_id: 1, main_weapon_id: 32, headgear_id: 5, clothing_id: 15, shoes_id: 34)
GearSet.create(user_id: 1, main_weapon_id: 33, headgear_id: 5, clothing_id: 15, shoes_id: 34)
GearSet.create(user_id: 1, main_weapon_id: 34, headgear_id: 5, clothing_id: 15, shoes_id: 34)
GearSet.create(user_id: 1, main_weapon_id: 35, headgear_id: 5, clothing_id: 15, shoes_id: 34)
GearSet.create(user_id: 1, main_weapon_id: 36, headgear_id: 9, clothing_id: 17, shoes_id: 31)
GearSet.create(user_id: 1, main_weapon_id: 37, headgear_id: 9, clothing_id: 17, shoes_id: 31)
GearSet.create(user_id: 1, main_weapon_id: 38, headgear_id: 4, clothing_id: 15, shoes_id: 34)
GearSet.create(user_id: 1, main_weapon_id: 39, headgear_id: 5, clothing_id: 15, shoes_id: 34)
GearSet.create(user_id: 1, main_weapon_id: 40, headgear_id: 5, clothing_id: 15, shoes_id: 34)
GearSet.create(user_id: 1, main_weapon_id: 41, headgear_id: 4, clothing_id: 15, shoes_id: 34)
GearSet.create(user_id: 1, main_weapon_id: 42, headgear_id: 4, clothing_id: 15, shoes_id: 34)
GearSet.create(user_id: 1, main_weapon_id: 43, headgear_id: 6, clothing_id: 20, shoes_id: 32)
GearSet.create(user_id: 1, main_weapon_id: 44, headgear_id: 6, clothing_id: 20, shoes_id: 32)
GearSet.create(user_id: 1, main_weapon_id: 45, headgear_id: 10, clothing_id: 20, shoes_id: 32)
GearSet.create(user_id: 1, main_weapon_id: 46, headgear_id: 4, clothing_id: 23, shoes_id: 34)
GearSet.create(user_id: 1, main_weapon_id: 47, headgear_id: 5, clothing_id: 23, shoes_id: 34)
GearSet.create(user_id: 1, main_weapon_id: 48, headgear_id: 12, clothing_id: 26, shoes_id: 34)
GearSet.create(user_id: 1, main_weapon_id: 49, headgear_id: 4, clothing_id: 15, shoes_id: 34)
GearSet.create(user_id: 1, main_weapon_id: 50, headgear_id: 12, clothing_id: 25, shoes_id: 36)
GearSet.create(user_id: 1, main_weapon_id: 51, headgear_id: 6, clothing_id: 29, shoes_id: 34)
GearSet.create(user_id: 1, main_weapon_id: 52, headgear_id: 6, clothing_id: 29, shoes_id: 34)
GearSet.create(user_id: 1, main_weapon_id: 53, headgear_id: 6, clothing_id: 29, shoes_id: 34)
GearSet.create(user_id: 1, main_weapon_id: 54, headgear_id: 13, clothing_id: 29, shoes_id: 34)
GearSet.create(user_id: 1, main_weapon_id: 55, headgear_id: 6, clothing_id: 29, shoes_id: 34)
GearSet.create(user_id: 1, main_weapon_id: 56, headgear_id: 4, clothing_id: 15, shoes_id: 34)
GearSet.create(user_id: 1, main_weapon_id: 57, headgear_id: 4, clothing_id: 15, shoes_id: 34)
GearSet.create(user_id: 1, main_weapon_id: 58, headgear_id: 4, clothing_id: 15, shoes_id: 34)
GearSet.create(user_id: 1, main_weapon_id: 59, headgear_id: 10, clothing_id: 15, shoes_id: 34)
GearSet.create(user_id: 1, main_weapon_id: 60, headgear_id: 6, clothing_id: 15, shoes_id: 34)
GearSet.create(user_id: 1, main_weapon_id: 61, headgear_id: 6, clothing_id: 18, shoes_id: 34)
GearSet.create(user_id: 1, main_weapon_id: 62, headgear_id: 10, clothing_id: 23, shoes_id: 34)
GearSet.create(user_id: 1, main_weapon_id: 63, headgear_id: 10, clothing_id: 23, shoes_id: 34)
GearSet.create(user_id: 1, main_weapon_id: 64, headgear_id: 6, clothing_id: 15, shoes_id: 34)
GearSet.create(user_id: 1, main_weapon_id: 65, headgear_id: 13, clothing_id: 15, shoes_id: 34)
GearSet.create(user_id: 1, main_weapon_id: 66, headgear_id: 6, clothing_id: 15, shoes_id: 34)
GearSet.create(user_id: 1, main_weapon_id: 67, headgear_id: 10, clothing_id: 28, shoes_id: 34)
GearSet.create(user_id: 1, main_weapon_id: 68, headgear_id: 6, clothing_id: 28, shoes_id: 34)
GearSet.create(user_id: 1, main_weapon_id: 69, headgear_id: 6, clothing_id: 28, shoes_id: 34)
GearSet.create(user_id: 1, main_weapon_id: 70, headgear_id: 4, clothing_id: 15, shoes_id: 34)
GearSet.create(user_id: 1, main_weapon_id: 71, headgear_id: 4, clothing_id: 15, shoes_id: 34)
GearSet.create(user_id: 1, main_weapon_id: 72, headgear_id: 4, clothing_id: 15, shoes_id: 34)
GearSet.create(user_id: 1, main_weapon_id: 73, headgear_id: 4, clothing_id: 15, shoes_id: 34)
GearSet.create(user_id: 1, main_weapon_id: 74, headgear_id: 4, clothing_id: 15, shoes_id: 34)
GearSet.create(user_id: 1, main_weapon_id: 75, headgear_id: 4, clothing_id: 15, shoes_id: 34)
GearSet.create(user_id: 1, main_weapon_id: 76, headgear_id: 4, clothing_id: 15, shoes_id: 34)
GearSet.create(user_id: 1, main_weapon_id: 77, headgear_id: 4, clothing_id: 15, shoes_id: 34)
GearSet.create(user_id: 1, main_weapon_id: 78, headgear_id: 4, clothing_id: 15, shoes_id: 34)
GearSet.create(user_id: 1, main_weapon_id: 79, headgear_id: 4, clothing_id: 15, shoes_id: 34)
GearSet.create(user_id: 1, main_weapon_id: 80, headgear_id: 14, clothing_id: 16, shoes_id: 35)
GearSet.create(user_id: 1, main_weapon_id: 81, headgear_id: 14, clothing_id: 16, shoes_id: 35)
GearSet.create(user_id: 1, main_weapon_id: 82, headgear_id: 14, clothing_id: 16, shoes_id: 35)
GearSet.create(user_id: 1, main_weapon_id: 83, headgear_id: 5, clothing_id: 15, shoes_id: 34)
GearSet.create(user_id: 1, main_weapon_id: 84, headgear_id: 5, clothing_id: 15, shoes_id: 34)
GearSet.create(user_id: 1, main_weapon_id: 85, headgear_id: 5, clothing_id: 15, shoes_id: 34)
GearSet.create(user_id: 1, main_weapon_id: 86, headgear_id: 4, clothing_id: 15, shoes_id: 34)
GearSet.create(user_id: 1, main_weapon_id: 87, headgear_id: 5, clothing_id: 15, shoes_id: 34)
GearSet.create(user_id: 1, main_weapon_id: 88, headgear_id: 10, clothing_id: 18, shoes_id: 34)
GearSet.create(user_id: 1, main_weapon_id: 89, headgear_id: 10, clothing_id: 18, shoes_id: 34)
GearSet.create(user_id: 1, main_weapon_id: 90, headgear_id: 9, clothing_id: 17, shoes_id: 31)
GearSet.create(user_id: 1, main_weapon_id: 91, headgear_id: 9, clothing_id: 21, shoes_id: 31)
GearSet.create(user_id: 1, main_weapon_id: 92, headgear_id: 9, clothing_id: 17, shoes_id: 31)
GearSet.create(user_id: 1, main_weapon_id: 93, headgear_id: 4, clothing_id: 15, shoes_id: 34)
GearSet.create(user_id: 1, main_weapon_id: 94, headgear_id: 4, clothing_id: 15, shoes_id: 34)
GearSet.create(user_id: 1, main_weapon_id: 95, headgear_id: 4, clothing_id: 15, shoes_id: 34)
GearSet.create(user_id: 1, main_weapon_id: 96, headgear_id: 4, clothing_id: 15, shoes_id: 34)
GearSet.create(user_id: 1, main_weapon_id: 97, headgear_id: 4, clothing_id: 27, shoes_id: 32)
GearSet.create(user_id: 1, main_weapon_id: 98, headgear_id: 4, clothing_id: 27, shoes_id: 32)
GearSet.create(user_id: 1, main_weapon_id: 99, headgear_id: 4, clothing_id: 27, shoes_id: 32)
GearSet.create(user_id: 1, main_weapon_id: 100, headgear_id: 4, clothing_id: 27, shoes_id: 32)
GearSet.create(user_id: 1, main_weapon_id: 101, headgear_id: 4, clothing_id: 27, shoes_id: 32)
GearSet.create(user_id: 1, main_weapon_id: 102, headgear_id: 4, clothing_id: 27, shoes_id: 32)
GearSet.create(user_id: 1, main_weapon_id: 103, headgear_id: 4, clothing_id: 27, shoes_id: 32)
GearSet.create(user_id: 1, main_weapon_id: 104, headgear_id: 4, clothing_id: 27, shoes_id: 32)
GearSet.create(user_id: 1, main_weapon_id: 105, headgear_id: 4, clothing_id: 27, shoes_id: 32)
GearSet.create(user_id: 1, main_weapon_id: 106, headgear_id: 4, clothing_id: 27, shoes_id: 32)
GearSet.create(user_id: 1, main_weapon_id: 107, headgear_id: 4, clothing_id: 27, shoes_id: 32)
GearSet.create(user_id: 1, main_weapon_id: 108, headgear_id: 4, clothing_id: 27, shoes_id: 32)
GearSet.create(user_id: 1, main_weapon_id: 109, headgear_id: 13, clothing_id: 23, shoes_id: 34)
GearSet.create(user_id: 1, main_weapon_id: 110, headgear_id: 10, clothing_id: 23, shoes_id: 34)
GearSet.create(user_id: 1, main_weapon_id: 111, headgear_id: 6, clothing_id: 18, shoes_id: 34)
GearSet.create(user_id: 1, main_weapon_id: 112, headgear_id: 10, clothing_id: 18, shoes_id: 34)
GearSet.create(user_id: 1, main_weapon_id: 113, headgear_id: 6, clothing_id: 18, shoes_id: 34)
GearSet.create(user_id: 1, main_weapon_id: 114, headgear_id: 6, clothing_id: 18, shoes_id: 34)
GearSet.create(user_id: 1, main_weapon_id: 115, headgear_id: 4, clothing_id: 15, shoes_id: 34)
GearSet.create(user_id: 1, main_weapon_id: 116, headgear_id: 4, clothing_id: 15, shoes_id: 34)
GearSet.create(user_id: 1, main_weapon_id: 117, headgear_id: 5, clothing_id: 15, shoes_id: 34)
GearSet.create(user_id: 1, main_weapon_id: 118, headgear_id: 4, clothing_id: 23, shoes_id: 34)
GearSet.create(user_id: 1, main_weapon_id: 119, headgear_id: 4, clothing_id: 18, shoes_id: 34)
GearSet.create(user_id: 1, main_weapon_id: 120, headgear_id: 6, clothing_id: 15, shoes_id: 34)
GearSet.create(user_id: 1, main_weapon_id: 121, headgear_id: 10, clothing_id: 15, shoes_id: 34)
GearSet.create(user_id: 1, main_weapon_id: 122, headgear_id: 4, clothing_id: 15, shoes_id: 32)
GearSet.create(user_id: 1, main_weapon_id: 123, headgear_id: 4, clothing_id: 15, shoes_id: 32)
GearSet.create(user_id: 1, main_weapon_id: 124, headgear_id: 4, clothing_id: 15, shoes_id: 34)
GearSet.create(user_id: 1, main_weapon_id: 125, headgear_id: 4, clothing_id: 15, shoes_id: 34)
GearSet.create(user_id: 1, main_weapon_id: 126, headgear_id: 4, clothing_id: 15, shoes_id: 34)
GearSet.create(user_id: 1, main_weapon_id: 127, headgear_id: 7, clothing_id: 21, shoes_id: 31)
GearSet.create(user_id: 1, main_weapon_id: 128, headgear_id: 7, clothing_id: 17, shoes_id: 31)
GearSet.create(user_id: 1, main_weapon_id: 129, headgear_id: 7, clothing_id: 17, shoes_id: 31)
